...
public class Lab4 extends GraphicsLab
{
    ...
    protected void renderScene()
    {
        ...
        // how shiny are the front faces of the house (specular exponent between 0 and 128)
        ...
        float houseFrontDiffuse[]  = {0.55f, 0.308f, 0.0f, 1.0f};
    ...
    {
        // the vertices for the cube (note that all sides have a length of 1)
        Vertex v1 = new Vertex(-0.1f, -0.5f,  0.5f);
        Vertex v2 = new Vertex(-0.1f, -0.3f,  0.5f);
        Vertex v3 = new Vertex( 0.1f, -0.3f,  0.5f);
        Vertex v4 = new Vertex( 0.1f, -0.5f,  0.5f);
        Vertex v5 = new Vertex(-0.1f, -0.5f,  0.6f);
        Vertex v6 = new Vertex(-0.1f, -0.3f,  0.6f);
        Vertex v7 = new Vertex( 0.1f, -0.3f,  0.6f);
        Vertex v8 = new Vertex( 0.1f, -0.5f,  0.6f);
