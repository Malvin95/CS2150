...
{	
    ...
    protected void renderScene()
    {
        ...
        GL11.glPushMatrix();
        {
	        ...
	        drawUnitCube(Colour.GREEN,Colour.CYAN,Colour.WHITE,Colour.WHITE,Colour.BLUE,Colour.BLUE);
        }
        GL11.glPopMatrix();
        ...
        GL11.glPushMatrix();
        {
	        ...
	        drawUnitCube(Colour.ORANGE,Colour.CYAN,Colour.WHITE,Colour.WHITE,Colour.BLUE,Colour.BLUE);
        }
       GL11.glPopMatrix();
        ...
        GL11.glPushMatrix();
        {
	        ...
	        GL11.glTranslatef(0.0f, 1.0f, -6.0f);
	        drawUnitCube(Colour.RED,Colour.CYAN,Colour.WHITE,Colour.WHITE,Colour.BLUE,Colour.BLUE);
        }
        GL11.glPopMatrix();
    }
