...
public class Lab3 extends GraphicsLab
{
    ...
    protected void initScene()
    {
        ...
        {   
        	...
        	drawUnitRoof(Colour.ORANGE,Colour.ORANGE,Colour.BLUE,Colour.BLUE,Colour.BLUE);
        }
        GL11.glEndList();
    }
    ...
    protected void renderScene()
    {
        ...
        // Malvins' Note: Scale Command added to test effect. Scaling similarities
        //to the Autodesk 3Ds Max programme 
        GL11.glScalef(1.5f, 1.0f, 2.0f);
